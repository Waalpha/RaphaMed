    ...
    <div id="hospital-workspace" className="min-h-screen bg-slate-50 flex flex-col md:flex-row">
      ...
      <main className="flex-1 p-6 space-y-6 overflow-y-auto">
        ...
        <div className="flex justify-between items-center bg-white p-4 rounded-xl border border-slate-200 shadow-xs">
          <div>
            <span className="text-[10px] bg-slate-100 text-slate-700 px-2 py-0.5 rounded-full font-bold uppercase tracking-wider">Secure Branch: {hospitalId.toUpperCase()}</span>
        ...
        {loading ? (
          <div className="p-20 text-center text-slate-500 bg-white rounded-xl border border-slate-200">
            ...
            <span className="font-semibold text-sm">Validating Branch Isolation Keys & Fetching Electronic Medical Records...</span>
          </div>
        ) : (
            ...
            {activeTab === 'dashboard' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
                  ...
                  <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm flex items-center justify-between">
                    <div>
                      <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Branch Revenue Yield</span>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="p-3 bg-emerald-50 border border-emerald-100 rounded-lg flex gap-2.5">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-emerald-700 mt-0.5">Firestore query limits strictly bounded to hospitalId '{hospitalId}'. Cross-branch query execution is forbidden.</p>
                        </div>
                      </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                  <div className="p-4 border-b border-slate-100 bg-slate-50">
                    <h3 className="font-bold text-slate-800 text-sm">Branch Electronic Medical Directory</h3>
                  </div>
                ...
                <div className="lg:col-span-2 bg-white rounded-xl border border-slate-200 shadow-sm p-4 space-y-4">
                  ...
                  <div className="space-y-3">
                    {records.filter(r => r.prescriptions && r.prescriptions.length > 0).length === 0 ? (
                      <p className="text-xs text-slate-400 text-center py-6">No prescriptions registered in branch system.</p>
                    ) : (
              ...
              <div className="space-y-6">
                <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1">Real-time status tracking of multi-ward inpatient beds inside hospital branch.</p>
                  </div>
                ...
                <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-4">
                  ...
                  <div className="space-y-3">
                    {records.filter(r => r.theatreNotes).length === 0 ? (
                      <p className="text-xs text-slate-400 text-center py-6">No surgical cases registered in branch logs.</p>
                    ) : (
                ...
                <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-4">
                  ...
                  <div className="space-y-3">
                    {records.filter(r => r.maternityNotes).length === 0 ? (
                      <p className="text-xs text-slate-400 text-center py-6">No maternal records logged in branch file.</p>
                    ) : (
